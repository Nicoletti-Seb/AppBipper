...
public class MyNotificationTask extends AsyncTask<String, Void, String> {
    ...
    public MyNotificationTask(NotificationItemAdapter notificationItemAdapter, Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String service = String.format(context.getString(R.string.url_service_my_notification), id);
